...
const poiSchema = z.object({
  ...
  // WanderSync-owned prose written from the cited sources below -- never a copied provider
  // description, and never a safety claim (halalStatus/allergenRisk carry that, with provenance).
...
const REFERENCE_POIS: PoiSeedRow[] = [
  // --- KLCC ---
  {
    ...
    shortDescription: "Twin 451.9 m office towers joined by a double-decker skybridge, the defining landmark of the KLCC skyline.",
  ...
  },
  {
    ...
    shortDescription: "A free public park at the foot of the Petronas Twin Towers, with shaded walking paths and a wading pool.",
    officialUrl: null,
  ...
  },
  {
    ...
    shortDescription: "An indoor aquarium on the concourse level of the KL Convention Centre, built around a walk-through tunnel.",
  ...
  },
  {
    ...
    shortDescription: "The shopping centre at the base of the Petronas Twin Towers, with several retail floors and a food court level.",
    officialUrl: null,
  ...
  },
  {
    ...
    indoor: true, dressCode: "none", touristDensity: "medium", heightM: null, landmarkClass: null,
    shortDescription: "A mid-size shopping mall on Jalan Ampang opposite the Petronas Twin Towers, linked to the KLCC LRT station.",
    officialUrl: "https://www.avenuek.com.my/",
  ...
  },
  {
    ...
    halalStatus: "unknown", allergenRisk: [], allergenDataUnknown: true,
    indoor: true, dressCode: "none", touristDensity: "medium", heightM: null, landmarkClass: null,
    shortDescription: "A cluster of rooftop restaurants and bars on level 23A of The Troika, overlooking the KLCC skyline.",
    officialUrl: "https://troikaskydining.com/",
  ...
  // --- Bukit Bintang ---
  {
    ...
    shortDescription: "A 421 m communications tower with a public observation deck, standing on Bukit Nanas above the city centre.",
    officialUrl: "https://kltower.com.my/",
  ...
  },
  {
    ...
    costTier: "standard", tags: ["shopping", "mall", "food"], ...NOT_A_FOOD_POI,
    indoor: true, dressCode: "none", touristDensity: "high", heightM: null, landmarkClass: null,
    shortDescription: "A large shopping centre on Jalan Bukit Bintang, anchoring the Bukit Bintang retail district.",
    officialUrl: null,
  ...
  },
  {
    ...
    indoor: false, dressCode: "none", touristDensity: "high", heightM: null, landmarkClass: null,
    shortDescription: "A street-food strip in Bukit Bintang lined with around two hundred stalls and open-front restaurants, busiest after dark.",
    officialUrl: null,
  ...
  },
  {
    ...
    indoor: true, dressCode: "none", touristDensity: "high", heightM: null, landmarkClass: null,
    shortDescription: "The Pavilion KL branch of a Malaysian coffee-shop chain serving Ipoh white coffee and kopitiam dishes.",
    officialUrl: null,
  ...
  },
  {
    ...
    costTier: "standard", tags: ["shopping", "mall"], ...NOT_A_FOOD_POI,
    indoor: true, dressCode: "none", touristDensity: "high", heightM: null, landmarkClass: null,
    shortDescription: "A shopping mall on Jalan Bukit Bintang opposite Pavilion KL, focused on fashion and lifestyle retail.",
    officialUrl: null,
  ...
  // --- Old Town / Melaka ---
  {
    ...
    shortDescription: "The surviving gatehouse of a Portuguese fortress begun in 1511, inside the Melaka UNESCO World Heritage core zone.",
    officialUrl: null,
  ...
  },
  {
    ...
    indoor: false, dressCode: "none", touristDensity: "high", heightM: null, landmarkClass: "architectural_typology",
    shortDescription: "An eighteenth-century Dutch-built church on Dutch Square, still in use and among Melaka's most photographed buildings.",
    officialUrl: null,
  ...
  },
  {
    ...
    indoor: false, dressCode: "none", touristDensity: "high", heightM: null, landmarkClass: "architectural_typology",
    shortDescription: "The 1650s Dutch administrative building on Dutch Square, the oldest surviving Dutch structure in the region, now a museum complex.",
    officialUrl: null,
  ...
  },
  {
    ...
    shortDescription: "Malaysia's oldest continuously operating Chinese temple, founded in 1645 on Jalan Tokong.",
    officialUrl: null,
  ...
  },
  {
    ...
    indoor: false, dressCode: "none", touristDensity: "high", heightM: null, landmarkClass: null,
    shortDescription: "Melaka Chinatown's heritage spine of shophouses, antique shops and eateries, closed to traffic for a weekend night market.",
    officialUrl: null,
  ...
  },
  {
    ...
    shortDescription: "A revolving gyro tower in Bandar Hilir that lifts visitors for a rotating view over Melaka and the strait.",
    officialUrl: "https://www.menaratamingsari.com/",
  ...
  },
  {
    ...
    indoor: false, dressCode: "none", touristDensity: "high", heightM: null, landmarkClass: "architectural_typology",
    shortDescription: "The roofless 1521 church ruin on top of St Paul's Hill, free to enter and open at all hours.",
    officialUrl: null,
  ...
  },
  {
    ...
    indoor: false, dressCode: "modest", touristDensity: "medium", heightM: null, landmarkClass: "architectural_typology",
    shortDescription: "A mosque founded in 1748 on Harmony Street, blending Sumatran, Chinese and colonial detailing.",
    officialUrl: null,
  ...
  },
  {
    ...
    shortDescription: "A preserved late-nineteenth-century Peranakan townhouse on Jalan Tun Tan Cheng Lock, shown as a family home.",
    officialUrl: "https://www.babanyonyamuseum.com/",
  ...
  },
  {
    ...
    indoor: true, dressCode: "none", touristDensity: "medium", heightM: null, landmarkClass: "architectural_typology",
    shortDescription: "A timber reconstruction of the Malacca Sultanate palace at the foot of St Paul's Hill, housing a cultural museum.",
    officialUrl: null,
  ...
  },
  {
    ...
    halalStatus: "unknown", allergenRisk: [], allergenDataUnknown: true,
    indoor: true, dressCode: "none", touristDensity: "high", heightM: null, landmarkClass: null,
    shortDescription: "A long-running Peranakan restaurant on Jonker Street known for home-style Nyonya cooking.",
    officialUrl: null,
  ...
  },
  {
    ...
    indoor: true, dressCode: "none", touristDensity: "medium", heightM: null, landmarkClass: null,
    shortDescription: "A Peranakan restaurant inside Hotel Equatorial Melaka in Bandar Hilir, serving Nyonya dishes in a hotel dining room.",
    officialUrl: null,
  ...
  },
  {
    ...
    halalStatus: "claimed", allergenRisk: [], allergenDataUnknown: true,
    indoor: true, dressCode: "none", touristDensity: "high", heightM: null, landmarkClass: null,
    shortDescription: "A cafe set behind a souvenir shop on Jonker Street, known for pandan and gula melaka pancakes.",
    officialUrl: null,
...
async function main() {
  ...
  for (const poi of parsed) {
    const { error } = await admin.from("poi_catalog").upsert({
      ...
      // Same source coordinate as geog above, in plain columns the choice pool can read over
      // PostgREST without depending on PostGIS serialization (migration 202609050012).
      latitude: poi.lat, longitude: poi.lng,
      short_description: poi.shortDescription, official_url: poi.officialUrl,
